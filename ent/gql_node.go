...
func (d *Directory) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     d.ID,
		Type:   "Directory",
		Fields: make([]*Field, 8),
	...
	var buf []byte
	if buf, err = json.Marshal(d.CreatedBy); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "int64",
	...
	if buf, err = json.Marshal(d.UpdatedBy); err != nil {
		return nil, err
	}
	node.Fields[1] = &Field{
		Type:  "int64",
	...
	if buf, err = json.Marshal(d.IsPublic); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "bool",
...
func (o *Object) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(o.URL); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(o.IsPublic); err != nil {
		return nil, err
	}
	node.Fields[7] = &Field{
		Type:  "bool",
...
func (c *Client) noder(ctx context.Context, table string, id int64) (Noder, error) {
	...
	case directory.Table:
		query := c.Directory.Query().
			Where(directory.ID(id))
		query, err := query.CollectFields(ctx, "Directory")
		if err != nil {
			return nil, err
		}
